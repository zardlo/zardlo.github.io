...
$(function(){
	...
	$("input[type='text'],input[type='password'],textarea").focus(function(){
		...
		var sty={"position":"absolute","left":l+"px","top":t+"px","zIndex":999}
		if(wt-l<660){
			sty={"position":"absolute","right":"0px","top":t+"px","zIndex":999}
		}
		$("<div>",{"id":"softkey","rel":$(this).attr("id")}).css(sty).appendTo("body")
